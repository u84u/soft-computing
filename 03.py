...
def demonstrate_defuzzification(universe, ag_mf):
    """
    ...
    print(f'Largest of Max (SoM):  {lom:.4f}')

    # --- Plot Visualization ---
    plt.figure(figsize=(10, 6))
    plt.plot(universe, ag_mf, 'b', linewidth=2.5, label='Aggregated Fuzzy Set')
    ...
    plt.plot([mom, mom], [0, 1.0], 'k:', label=f'MoM ({mom:.2f}')  # Using a vertical line
...
if __name__ == '__main__':
    ...
    # An example of an aggregated output fuzzy set (a trapezoid & triangle)
